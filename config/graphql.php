...
use App\GraphQL\Mutations\CreateServiceMutation;
use App\GraphQL\Mutations\CreateUserMutation;
use App\GraphQL\Mutations\DeleteCustomerMutation;
use App\GraphQL\Mutations\DeleteOrderMutation;
use App\GraphQL\Mutations\DeleteServiceMutation;
...
use App\GraphQL\Mutations\UpdateServiceMutation;
...
use App\GraphQL\Queries\ServiceQuery;
    ...
    'schemas' => [
        'default' => [
            ...
            'mutation' => [
                ...
                CreateCustomerMutation::class,
                CreateServiceMutation::class,
                UpdateServiceMutation::class,
                UpdateOrderMutation::class,
                UpdateCustomerMutation::class,
                UpdateUserMutation::class,
                DeleteOrderMutation::class,
                DeleteUserMutation::class,
                DeleteCustomerMutation::class,
                DeleteServiceMutation::class
            ],
